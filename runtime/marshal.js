...
var caml_output_val = function (){
  ...
  // TODO: there was some change related to iframes - `hasIsArray` I took the upstream code 
  return function (v, flags) {
    ...
    function extern_rec (v) {
      // TODO: there was some change related to iframes - `hasIsArray` I took the upstream code s
      if (v.caml_custom) {
        if (memo(v)) return;
